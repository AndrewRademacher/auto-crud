...
validPool = [
    {
        name: 'Computer',
        dimensions: {width: 21.23, height: 0.78, length: 15.44, weight: 2.34},
        price: 1782.34,
    ...
    {
        name: 'Boom Box',
        dimensions: {width: 51.23, height: 24.78, length: 15.44, weight: 32.34},
        price: 234.34,
    ...
    {
        name: 'Toilet',
        dimensions: {width: 56.23, height: 86.78, length: 43.44, weight: 332.34},
        price: 97.34,
...
invalidPool = [
    {
        ...
        dimensions: {height: 0.78, weight: '2.34'},
        price: 1782.34,
        description: 48934,
        salePrice: 1593.34,
        manufacturer: {
